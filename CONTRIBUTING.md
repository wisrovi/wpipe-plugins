# Contributing to wpipe-plugins
Thank you for your interest in contributing to wpipe-plugins!
## Getting Started
1. Fork the repository
2. Clone your fork:
```bash
git clone https://github.com/YOUR_USERNAME/wpipe-plugins.git
cd wpipe-plugins
```
3. Configure the upstream remote to keep your fork synced with the
main repository:
```bash
git remote add upstream
https://github.com/wisrovi/wpipe-plugins.git
```
...
1. Always pull the latest changes from the main repository before
working:
```bash
git checkout main
...
```
5. Go to the original `wpipe-plugins` repository on GitHub, and you
will see a banner to open a Pull Request from your branch.
## Development
### Running Tests
```bash
# Run all tests
...
4. Update documentation or README if needed (add your plugin
description)
5. Keep changes focused and atomic
6. Make sure you are submitting the PR from your fork's branch to
`wpipe-plugins:main`
## Code Style
- Follow PEP 8
